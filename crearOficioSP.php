...
<div class="container">
	<div class="card">
		<form action="crearOficioSP.php" method="post">
			<div align="center">
				<h1>Ingresa los datos del Oficio</h1>
			</div>
			<div class="form-group">
				<label for="validation01">Folio</label>
				<input name="folioOficio" type="text" class="form-control is-valid" id="validation01" placeholder="Folio" value="" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input name="folioOficioExterno" type="text" class="form-control is-valid" id="validation05" placeholder="Folio Externo" value="" required>
			</div>
			<div class="form-group">
				<label for="validation06">Asunto</label>
				<input name="asuntoOficio" type="text" class="form-control is-valid" id="validation06" placeholder="Asunto" value="" required>
			</div>
			<div class="form-group">
				<label for="validation07">Nombre de la Empresa Promovente</label>
				<input name="nombreEmpresa" type="text" class="form-control is-valid" id="validation07" placeholder="Nombre de la Empresa Promovente" value="" required>
			</div>
			<div class="form-group">
				<label for="validation08">Nombre del Promovente</label>
				<input name="nombrePromovente" type="text" class="form-control is-valid" id="validation08" placeholder="Nombre del Promovente" value="" required>
			</div>
			<div class="form-group">
				<label for="validation09">Apellido Paterno del Promovente</label>
				<input name="apellidoPaternoPromovente" type="text" class="form-control is-valid" id="validation09" placeholder="Apellido Paterno del Promovente" value="" required>
			</div>
			<div class="form-group">
				<label for="validation10">Apellido Materno del Promovente</label>
				<input name="apellidoMaternoPromovente" type="text" class="form-control is-valid" id="validation10" placeholder="Apellido Materno del Promovente" value="" required>
			</div>
			<div class="form-group">
				<label for="validation11">Anexos</label>
				<input name="anexoOficio" type="text" class="form-control is-valid" id="validation11" placeholder="Anexos" value="" required>
			</div>
			<div class="form-group">
			<?php
			...
			<div class="form-group">
				<div class="col-sm-12" align="right">
					<br>
					<button onclick="location.href='home.php'" name="btnCancelar" type="submit" class="btn">Cancelar</button>
	...
	if(isset($_POST["btnEnviar"])){
		...
		if ($conn != null) {
			...
			if($consult ->rowCount()>=1){
				...
				location.href = 'crearOficioSP.php';
				</script>";
			}else{
