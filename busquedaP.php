...
<div class="container">
	...
	<h1 align="center">Búsqueda de Oficio</h1>
		...
		<?php
			...
			echo "<script> alert('No existe este registro en el sistema');
...
<div class="container">
	<div class="card">
		<div class="form-group row" align="right">
			<div class="col-sm-12">
				<br>
				<button onclick="location.href='index.php'" name="btnRegresar" type="submit" class="btn">Regresar</button>
			</div>
		</div>
	</div>
</div>
