...
<div class="container">
	<div class="card">
		<form action="updateOficioSP.php" method="post">
			<div align="center">
			...
			<div class="form-group">
				...
				<input name="folioOficio" type="text" class="form-control is-valid" id="validation01" placeholder="Folio" value="<?php echo $oficio->folioOficio; ?>" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input name="folioOficioExterno" type="text" class="form-control is-valid" id="validation05" placeholder="Folio Externo" value="<?php echo $oficio->folioOficioExterno; ?>" required>
			</div>
			<div class="form-group">
				<label for="validation06">Asunto</label>
				<input name="asuntoOficio" type="text" class="form-control is-valid" id="validation06" placeholder="Asunto" value="<?php echo $oficio->asuntoOficio; ?>" required>
			</div>
			<div class="form-group">
				<label for="validation07">Nombre de la Empresa Promovente</label>
				<input name="nombreEmpresa" type="text" class="form-control is-valid" id="validation07" placeholder="Nombre de la Empresa Promovente" value="<?php echo $oficio->nombreEmpresa; ?>" required>
			</div>
			<div class="form-group">
				<label for="validation08">Nombre del Promovente</label>
				<input name="nombrePromovente" type="text" class="form-control is-valid" id="validation08" placeholder="Nombre del Promovente" value="<?php echo $oficio->nombrePromovente; ?>" required>
			</div>
			<div class="form-group">
				<label for="validation09">Apellido Paterno del Promovente</label>
				<input name="apellidoPaternoPromovente" type="text" class="form-control is-valid" id="validation09" placeholder="Apellido Paterno del Promovente" value="<?php echo $oficio->apellidoPaternoPromovente; ?>" required>
			</div>
			<div class="form-group">
				<label for="validation10">Apellido Materno del Promovente</label>
				<input name="apellidoMaternoPromovente" type="text" class="form-control is-valid" id="validation10" placeholder="Apellido Materno del Promovente" value="<?php echo $oficio->apellidoMaternoPromovente; ?>" required>
			</div>
			<div class="form-group">
				<label for="validation11">Anexos</label>
				<input name="anexoOficio" type="text" class="form-control is-valid" id="validation11" placeholder="Anexos" value="<?php echo $oficio->anexoOficio; ?>" required>
			</div>
			<div class="form-group">
			<?php
